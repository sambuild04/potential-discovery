      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-400">
            Welcome to Potential Discovery. We are committed to protecting your privacy and ensuring you have a positive experience on our website. This Privacy Policy outlines how we collect, use, and protect your personal information.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-400">
            We collect personal information that you voluntarily provide to us when you register on the website, express an interest in obtaining information about us or our products and services, when you participate in activities on the website, or otherwise contact us. The personal information that we collect depends on the context of your interactions with us and the website, the choices you make and the products and features you use. The personal information we collect may include the following:
          </p>
          <ul className="list-disc list-inside text-gray-700 dark:text-gray-400 ml-4 mt-2">
            <li>Email address</li>
            <li>User-generated content (e.g., posts, images, videos)</li>
            <li>Any other information you choose to provide.</li>
          </ul>

          <h3 className="text-xl font-semibold mb-2 mt-4">Automatically Collected Information:</h3>
          <p className="text-gray-700 dark:text-gray-400">
            When you visit, use, or navigate the website, we may automatically collect certain information. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our website, and other technical information. This information is primarily needed to maintain the security and operation of our website, and for our internal analytics and reporting purposes.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-gray-700 dark:text-gray-400 ml-4 mt-2">
            ...
            <li>To enable personalized book recommendations based on your content.</li>
          </ul>
        </section>
